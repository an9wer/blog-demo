...
def index():
    ...
    pagination = Post.query.order_by(Post.publish_time.desc())\
    ...
    if name and email and body :
        ...
        if v:
            ...
            if v.email == email:
                ...
                '''If the visitor name is existed but the email is not existed, 
                   It means that the visitor's name has been registered.
                   It is not allowed.
                '''
